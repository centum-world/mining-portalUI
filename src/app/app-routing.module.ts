...
const routes: Routes = [
  ...
  { path: "privacy-policy", component: PrivacyComponent },
  {
    ...
    children: [
      ...
      {
        path: "today-transaction-history",
        component: TodayTransactionHistoryComponent,
      },
      { path: "sho-history", component: ShoHistoryComponent },
      {
        path: "franchise-history",
        component: FranchiseHistoryComponentComponent,
      },
      ...
      {
        path: "partner-wallet-history",
        component: PartnerWalletHistoryComponent,
      },
      {
        path: "member-wallet-history",
        component: MemberWalletHistoryComponent,
      },
      {
        path: "member-withdrawal-request",
        component: MemberWithdrawalRequestComponent,
      },
      {
        path: "member-approved-withdrawals",
        component: MemberApprovedWithdrawalHistoryComponent,
      },
      {
        path: "partner-withdrawal-request",
        component: PartnerWithdrawalRequestComponent,
      },
      {
        path: "partner-approved-withdrawal",
        component: PartnerApprovedWithdrawalHistoryComponent,
      },
      {
        path: "partner-referral-payout-request",
        component: PartnerReferralPayoutRequestComponent,
      },
      { path: "pending-partners", component: PendingPartnersComponent },
      {
        path: "partner-referral-payout-approved",
        component: PartnerReferralPayoutApprovedComponent,
      },
      { path: "partner-account/:id/:type", component: RigPartnerComponent },
      {
        path: "partner-account/:userId/:type/:rigId",
        component: PartnerPayoutComponent,
      },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "invoice-bond/:rigId", component: InvoiceBondComponent },
      {
        ...
        component: PartnerTransactionHistoryComponent,
      },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "withdrawal-list", component: WithdrawlFranchiseComponent },
      {
        ...
        component: FranchiseWithdrawalRequestComponent,
      },
      {
        path: "withdrawal-history",
        component: FranchiseWithdrawalSuccessHistoryComponent,
      },
  ...
  },
  {
    path: "bd-dashboard",
    canActivate: [GuardGuard],
    component: BdDashboardComponent,
    children: [
      { path: "home", component: BdCardsComponent },
      { path: "withdrawal-list", component: BDpaymentRequestComponent },
      {
        path: "withdrawal-request-history",
        component: WithdrawalRequestHistoryComponent,
      },
      {
        path: "withdrawal-success-history",
        component: WithdrawalSuccessHistoryComponent,
      },
      {
        path: "businessDev-partner-team",
        component: BusinessDevPartnerTeamComponent,
      },
